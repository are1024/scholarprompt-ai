...
def render_create_prompt_page():
    ...
    if submitted:
        ...
        try:
            ...
            # فراخوانی سرویس تولید پرامپت
            prompt_entity = PromptEngineService.generate_prompt(dto)
    ...
    # نمایش پرامپت، دکمه کپی واقعی و دکمه ذخیره دستی
    if "last_generated_prompt" in st.session_state:
        ...
        if st.button("ذخیره پرامپت در تاریخچه 💾", use_container_width=True):
            st.warning("با عرض پوزش در حال  حاضر امکان ذخیره سازی پرامپت در سامانه وجود ندارد. ⚠️")