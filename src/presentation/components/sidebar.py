        ...
        with st.form("login_form"):
            ...
            if submit_login:
                try:
                    ...
                    # ذخیره refresh_token هم در URL (برای رفرش آنی F5) و هم در کوکی (برای بستن مرورگر)
...
def render_sidebar():
    with st.sidebar:
        # نمایش پیام توست در صورت موفقیت‌آمیز بودن ورود
        if st.session_state.get("show_login_toast", False):
            st.toast("برای ذخیره سازی حساب در مرورگر یکبار صفحه سایت را رفرش کنید.", icon="⚠️")
        ...
        if "user" in st.session_state and st.session_state.user is not None:
            ...
            if st.button("🚪 خروج از حساب", use_container_width=True):
                ...
                # پاک کردن هم از URL و هم از کوکی هنگام خروج از حساب کاربری
        ...
        st.markdown("""
            <div style="text-align: center; margin-top: 20px;">
                <div style="display: flex; justify-content: center; gap: 20px; align-items: center;">
                    ...
                    <!-- لینک تلگرام -->
                    <a href="https://t.me" target="_blank" title="Telegram" style="color: #0088cc; text-decoration: none; display: flex; align-items: center;">
                        <svg height="22" width="22" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <!-- لینک گیت هاب -->
                    <a href="https://github.com" target="_blank" title="GitHub" style="color: inherit; text-decoration: none; display: flex; align-items: center;">
